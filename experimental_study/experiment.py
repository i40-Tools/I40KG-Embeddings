...
cls_measure = '/media/rivas/Data1/Projects/experimental_study/korona-graph-partitioning-master/utils/clusteringMeasures/'
list_embedding = {}
...
for key, address_embedding in list_embedding.items():
    ...
    for fold in range(k):
        ...
        #get_measure(cls_measure, folder_semep)
        #get_measure(cls_measure, folder_kmeans)
        #get_measure(cls_measure, folder_metis)



#address = '/media/rivas/Data1/Projects/experimental_study/korona-graph-partitioning-master/utils/clusteringMeasures '
#measure = './cma measures'+str(fold)+'/clusters/ measures'+str(fold)+'/entities.txt measures'+str(fold)+'/matrix_undirected_cosine.txt > output.txt'
#os.system(address + measure)
##measures'+str(fold)+'/